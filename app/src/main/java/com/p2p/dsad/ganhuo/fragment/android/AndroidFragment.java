package com.p2p.dsad.ganhuo.fragment.android;
...
public class AndroidFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener
{
    ...
    public final static String ANDROID_ID="android";
    @Override
    ...
    public void getDataFromSever() {
        //请求
        page = SpUtils.getInteger(GanApi.SP_GAN_NAME,ANDROID_ID);
        if (page==0)
        {
            page= Integer.parseInt(GanApi.DEFAUT_PAGE);
        }
        normalurl = ConnectionUtils.getCategoryUrls(GanApi.ANDROID,String.valueOf(count),String.valueOf(page));
    ...
    public void onRefresh()
    {
        ...
        page=page+1;
        //存一下
        SpUtils.setInteger(GanApi.SP_GAN_NAME,ANDROID_ID,page);
        //测试
        //count=count+20;
        //更新信息
        getDataFromSever();
